...
for riga in df_lista_ridotta.itertuples():
    ...
    if not df1.empty:
        ...
        for tweet in df1.itertuples():
            ...
            if tweet not in donne_dictionary[pippo]["tweets"]["pre-classifica"]:
                donne_dictionary[pippo]["tweets"]["pre-classifica"].append(tweet)
    ...
    if not df2.empty:
        ...
        for tweet in df2.itertuples():
            ...
            if tweet not in donne_dictionary[pippo]["tweets"]["post-classifica"]:
                donne_dictionary[pippo]["tweets"]["post-classifica"].append(tweet)


with open('popopopo.json', 'w', encoding="UTF-8") as f:
